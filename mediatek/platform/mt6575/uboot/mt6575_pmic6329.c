...
//	upmu_chr_chrind_on(0);    /*Keep nleds on if USB/Charger exists*/
...
int mt6575_detect_powerkey(void)
{
	U32 ret_code = I2C_OK;
	U8 chip_slave_address = mt6329_BANK0_SLAVE_ADDR_WRITE;
    U8 cmd = 0x09;
...
int mt6575_detect_homekey(void)
{
	U32 ret_code = I2C_OK;
	U8 chip_slave_address = mt6329_BANK0_SLAVE_ADDR_WRITE;
    U8 cmd = 0x0C;
