...
//==============================================================================
extern U32 i2c0_v1_init (void);
extern U32 i2c0_v1_deinit (void);
extern U32 i2c0_v1_set_speed (unsigned long clock, I2C_SPD_MODE mode, unsigned long khz);
extern U32 i2c0_v1_read(U8 chip, U8 *buffer, int len);
extern U32 i2c0_v1_write (U8 chip, U8 *buffer, int len);
extern void i2c0_workaround(void);
