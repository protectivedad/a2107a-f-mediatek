#ifndef __MT6575_LCD_DRV_H__
#define __MT6575_LCD_DRV_H__
...
/* Layer Designation */
#define ASSERT_LAYER    (LCD_LAYER_5)
#define FB_LAYER        (LCD_LAYER_4)


typedef enum {
   LCD_LAYER_FORMAT_INDEX       = 0,
   LCD_LAYER_FORMAT_RGB565      = 1,
   LCD_LAYER_FORMAT_YUYV422     = 2,
   LCD_LAYER_FORMAT_RGB888      = 3,
   LCD_LAYER_FORMAT_ARGB8888    = 4,
   LCD_LAYER_FORMAT_PARGB8888   = 5,
   LCD_LAYER_FORMAT_xRGB8888    = 6,
