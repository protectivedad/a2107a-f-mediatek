...
/* I/O mapping */
#define IO_PHYS            	0xC0000000 // 2010-11-12 Hong-Rong: Modified for MT6575
...
#define HDQ_BASE         	(IO_PHYS + 0x00027000) // 6575 only    
#define KP_BASE         	(IO_PHYS + 0x0100E000)
#define RTC_BASE         	(IO_PHYS + 0x01003000)
#define SEJ_BASE         	(IO_PHYS + 0x0002D000) // 6575 only
#define I2C3_BASE         	(IO_PHYS + 0x0002E000) // 6575
...
#define PWM_BASE         	(IO_PHYS + 0x01008000) // 6575
 ...
 *                   F012 0000                    *
 **************************************************/
#define LCD_BASE           	(IO_PHYS + 0x020A1000) //2011-05-10, zaikuo for mt6575

/**************************************************
 *                   F013 0000                    *
 **************************************************/
#define DPI_BASE            (IO_PHYS + 0x0208C000) // 2011-05-25, zaikuo for 6575 dpi
