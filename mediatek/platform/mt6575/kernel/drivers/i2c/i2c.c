...
#define DRV_NAME    "mt6575-i2c"
//#define I2C_DEBUG_LOG
//	#define MT6575_I2C_HRTIMER_DEBUG
#define I2C_CLOCK
#define I2C_WORKAROUND
#define I2C2_CH2_ERR(dev,addr) 												\
	do{																		\
		dev_err(dev, " %5d mt6575-i2c:(%x) using ch2.\n",__LINE__, addr);	\
...
#define I2C_CLK_RATE            16250   /* khz for CPU_416MHZ_MCU_104MHZ*/
...
#define mt6575_I2C_DATA_PORT            ((base) + 0x0000)
#define mt6575_I2C_SLAVE_ADDR           ((base) + 0x0004)
#define mt6575_I2C_INTR_MASK            ((base) + 0x0008)
#define mt6575_I2C_INTR_STAT            ((base) + 0x000c)
#define mt6575_I2C_CONTROL              ((base) + 0x0010)
#define mt6575_I2C_TRANSFER_LEN         ((base) + 0x0014)
#define mt6575_I2C_TRANSAC_LEN          ((base) + 0x0018)
#define mt6575_I2C_DELAY_LEN            ((base) + 0x001c)
#define mt6575_I2C_TIMING               ((base) + 0x0020)
#define mt6575_I2C_START                ((base) + 0x0024)
#define mt6575_I2C_FIFO_STAT            ((base) + 0x0030)
#define mt6575_I2C_FIFO_THRESH          ((base) + 0x0034)
#define mt6575_I2C_FIFO_ADDR_CLR        ((base) + 0x0038)
#define mt6575_I2C_IO_CONFIG            ((base) + 0x0040)
#define mt6575_I2C_DEBUG                ((base) + 0x0044)
#define mt6575_I2C_HS                   ((base) + 0x0048)
#define mt6575_I2C_SOFTRESET            ((base) + 0x0050)
#define mt6575_I2C_IRQSEL               ((base) + 0x0060)
#define mt6575_I2C_DEBUGSTAT            ((base) + 0x0064)
#define mt6575_I2C_DEBUGCTRL            ((base) + 0x0068)
#define mt6575_I2C_CH2_DATA_PORT        ((base) + 0x0080)
#define mt6575_I2C_CH2_SLAVE_ADDR       ((base) + 0x0084)
#define mt6575_I2C_CH2_CONTROL          ((base) + 0x0090)
#define mt6575_I2C_CH2_TRANSFER_LEN     ((base) + 0x0094)
#define mt6575_I2C_CH2_TRANSAC_LEN      ((base) + 0x0098)
#define mt6575_I2C_CH2_DELAY_LEN        ((base) + 0x009c)
#define mt6575_I2C_CH2_TIMING           ((base) + 0x00a0)
#define mt6575_I2C_CH2_START            ((base) + 0x00a4)
#define mt6575_I2C_CH2_FIFO_STAT        ((base) + 0x00b0)
#define mt6575_I2C_CH2_FIFO_ADDR_CLR    ((base) + 0x00b8)

#define mt6575_I2C_TRANS_LEN_MASK           (0xff)
#define mt6575_I2C_TRANS_AUX_LEN_MASK       (0x1f << 8)
#define mt6575_I2C_CONTROL_MASK             (0x3f << 1)
#define mt6575_I2C_CH2_TRANS_LEN_MASK       (0x07)
#define mt6575_I2C_CH2_TRANS_AUX_LEN_MASK   (0x07 << 8)
#define mt6575_I2C_CH2_CONTROL_MASK         (0x7d << 1)
...
#define I2C_START_TRANSAC       __raw_writel(0x1,mt6575_I2C_START)
#define I2C_FIFO_CLR_ADDR       __raw_writel(0x1,mt6575_I2C_FIFO_ADDR_CLR)
#define I2C_FIFO_OFFSET         (__raw_readl(mt6575_I2C_FIFO_STAT)>>4&0xf)
#define I2C_FIFO_IS_EMPTY       (__raw_readw(mt6575_I2C_FIFO_STAT)>>0&0x1)
#define I2C_CH2_START_TRANSAC   __raw_writel(0x1,mt6575_I2C_CH2_START)
#define I2C_CH2_FIFO_CLR_ADDR   __raw_writel(0x1,mt6575_I2C_CH2_FIFO_ADDR_CLR)
#define I2C_CH2_FIFO_OFFSET     (__raw_readl(mt6575_I2C_CH2_FIFO_STAT)>>4&0xf)
#define I2C_CH2_FIFO_IS_EMPTY   (__raw_readw(mt6575_I2C_CH2_FIFO_STAT)>>0&0x1)
#define I2C_IRQSET_CH1             __raw_writel(0x0,mt6575_I2C_IRQSEL)
#define I2C_IRQSET_CH2             __raw_writel(0x1,mt6575_I2C_IRQSEL)
...
#define I2C_SET_FIFO_THRESH(tx,rx)	\
    do { u32 tmp = (((tx) & 0x7) << I2C_TX_THR_OFFSET) | \
        ...
        __raw_writel(tmp, mt6575_I2C_FIFO_THRESH); \
    } while(0)

#define I2C_SET_INTR_MASK(mask) I2C_SET_BITS(mask, mt6575_I2C_INTR_MASK)

#define I2C_CLR_INTR_MASK(mask)	I2C_CLR_BITS(mask, mt6575_I2C_INTR_MASK)


#define I2C_SET_SLAVE_ADDR(addr)        __raw_writel((addr)&0xFF, mt6575_I2C_SLAVE_ADDR)
#define I2C_SET_CH2_SLAVE_ADDR(addr)    __raw_writel((addr)&0xFF, mt6575_I2C_CH2_SLAVE_ADDR)

#define I2C_SET_TRANS_LEN(len)	 	\
    do { u32 tmp = __raw_readl(mt6575_I2C_TRANSFER_LEN) & \
                             ~(mt6575_I2C_TRANS_LEN_MASK); \
        tmp |= ((len) & mt6575_I2C_TRANS_LEN_MASK); \
        __raw_writel(tmp, mt6575_I2C_TRANSFER_LEN); \
    } while(0)

#define I2C_SET_CH2_TRANS_LEN(len)	 	\
    do { u32 tmp = __raw_readl(mt6575_I2C_CH2_TRANSFER_LEN) & \
                             ~(mt6575_I2C_CH2_TRANS_LEN_MASK); \
        tmp |= ((len) & mt6575_I2C_CH2_TRANS_LEN_MASK); \
        __raw_writel(tmp, mt6575_I2C_CH2_TRANSFER_LEN); \
    } while(0)
    
#define I2C_SET_TRANS_AUX_LEN(len)	\
    do { u32 tmp = __raw_readl(mt6575_I2C_TRANSFER_LEN) & \
                             ~(mt6575_I2C_TRANS_AUX_LEN_MASK); \
        tmp |= (((len) << 8) & mt6575_I2C_TRANS_AUX_LEN_MASK); \
        __raw_writel(tmp, mt6575_I2C_TRANSFER_LEN); \
    } while(0)

#define I2C_SET_CH2_TRANS_AUX_LEN(len)	\
    do { u32 tmp = __raw_readl(mt6575_I2C_CH2_TRANSFER_LEN) & \
                             ~(mt6575_I2C_CH2_TRANS_AUX_LEN_MASK); \
        tmp |= (((len) << 8) & mt6575_I2C_CH2_TRANS_AUX_LEN_MASK); \
        __raw_writel(tmp, mt6575_I2C_CH2_TRANSFER_LEN); \
    } while(0)
    
#define I2C_SET_TRANSAC_LEN(len)	__raw_writel(len, mt6575_I2C_TRANSAC_LEN)
#define I2C_SET_TRANS_DELAY(delay)	__raw_writel(delay, mt6575_I2C_DELAY_LEN)
#define I2C_SET_CH2_TRANSAC_LEN(len)	__raw_writel(len, mt6575_I2C_CH2_TRANSAC_LEN)
#define I2C_SET_CH2_TRANS_DELAY(delay)	__raw_writel(delay, mt6575_I2C_CH2_DELAY_LEN)

#define I2C_SET_TRANS_CTRL(ctrl)	\
    do { u32 tmp = __raw_readl(mt6575_I2C_CONTROL) & ~mt6575_I2C_CONTROL_MASK; \
        tmp |= ((ctrl) & mt6575_I2C_CONTROL_MASK); \
        __raw_writel(tmp, mt6575_I2C_CONTROL); \
    } while(0)
    
#define I2C_SET_CH2_TRANS_CTRL(ctrl)	\
    do { u32 tmp = __raw_readl(mt6575_I2C_CH2_CONTROL) & ~mt6575_I2C_CH2_CONTROL_MASK; \
        tmp |= ((ctrl) & mt6575_I2C_CH2_CONTROL_MASK); \
        __raw_writel(tmp, mt6575_I2C_CH2_CONTROL); \
    } while(0)

#define I2C_SET_HS_MODE(on_off) \
    do { u32 tmp = __raw_readl(mt6575_I2C_HS) & ~0x1; \
        tmp |= (on_off & 0x1); \
        __raw_writel(tmp, mt6575_I2C_HS); \
    } while(0)

#define I2C_READ_BYTE(byte)		\
    do { byte = __raw_readb(mt6575_I2C_DATA_PORT); } while(0)
#define I2C_CH2_READ_BYTE(byte)		\
    do { byte = __raw_readb(mt6575_I2C_CH2_DATA_PORT); } while(0)
	
#define I2C_WRITE_BYTE(byte)	\
    do { __raw_writeb(byte, mt6575_I2C_DATA_PORT); } while(0)
#define I2C_CH2_WRITE_BYTE(byte)	\
    do { __raw_writeb(byte, mt6575_I2C_CH2_DATA_PORT); } while(0)

#define I2C_CLR_INTR_STATUS(status)	\
    do { __raw_writew(status, mt6575_I2C_INTR_STAT); } while(0)

#define I2C_INTR_STATUS __raw_readw(mt6575_I2C_INTR_STAT)

/* mt6575 i2c control bits */
...
struct mt6575_i2c {
    ...
    spinlock_t          lock;		/* for mt6575_i2c struct protection */
    ...
    bool                use_ch2;
    u16                 delay_len;
    enum                mt6575_trans_op op;
#ifdef I2C_CLOCK
    MT65XX_CLOCK        pdn;
#endif
	struct mt6575_i2c_hrtimer_t i2c_hrtimer;
};
...
static int mt6575_i2c_set_speed(struct mt6575_i2c *i2c, int mode, unsigned long khz);

#ifdef MT6575_I2C_HRTIMER_DEBUG
...
/*
static i2c_regs mt6575_i2c_regs[3];
static void mt6575_i2c_init_regs(struct mt6575_i2c *i2c)
{
    u32 base            = i2c->base;
    i2c_regs *p         = &mt6575_i2c_regs[i2c->id];
    p->data             = (i2c_data_reg*)mt6575_I2C_DATA_PORT;
    p->slave_addr       = (i2c_slave_addr_reg*)mt6575_I2C_SLAVE_ADDR;
    p->intr_mask        = (i2c_intr_mask_reg*)mt6575_I2C_INTR_MASK;
    p->intr_stat        = (i2c_intr_stat_reg*)mt6575_I2C_INTR_STAT;
    p->control          = (i2c_control_reg*)mt6575_I2C_CONTROL;
    p->trans_len        = (i2c_trans_len_reg*)mt6575_I2C_TRANSFER_LEN;
    p->transac_len      = (i2c_transac_len_reg*)mt6575_I2C_TRANSAC_LEN;
    p->delay_len        = (i2c_delay_len_reg*)mt6575_I2C_DELAY_LEN;
    p->timing           = (i2c_timing_reg*)mt6575_I2C_TIMING;
    p->start            = (i2c_start_reg*)mt6575_I2C_START;
    p->fifo_stat        = (i2c_fifo_stat_reg*)mt6575_I2C_FIFO_STAT;
    p->fifo_thresh      = (i2c_fifo_thresh_reg*)mt6575_I2C_FIFO_THRESH;
    p->io_config        = (i2c_io_config_reg*)mt6575_I2C_IO_CONFIG;
    p->debug            = (i2c_debug_reg*)mt6575_I2C_DEBUG;
    p->hs               = (i2c_hs_reg*)mt6575_I2C_HS;
    p->dbg_stat         = (i2c_dbg_stat_reg*)mt6575_I2C_DEBUGSTAT;
    p->dbg_ctrl         = (i2c_dbg_ctrl_reg*)mt6575_I2C_DEBUGCTRL;		
    p->ch2_data         = (i2c_ch2_data_reg*)mt6575_I2C_CH2_DATA_PORT;
    p->ch2_slave_addr   = (i2c_ch2_slave_addr_reg*)mt6575_I2C_CH2_SLAVE_ADDR;
    p->ch2_control      = (i2c_ch2_control_reg*)mt6575_I2C_CH2_CONTROL;
    p->ch2_trans_len    = (i2c_ch2_trans_len_reg*)mt6575_I2C_CH2_TRANSFER_LEN;
    p->ch2_transac_len  = (i2c_ch2_transac_len_reg*)mt6575_I2C_CH2_TRANSAC_LEN;
    p->ch2_delay_len    = (i2c_ch2_delay_len_reg*)mt6575_I2C_CH2_DELAY_LEN;
    p->ch2_timing       = (i2c_ch2_timing_reg*)mt6575_I2C_CH2_TIMING;
    p->ch2_start        = (i2c_ch2_start_reg*)mt6575_I2C_CH2_START;
    p->ch2_fifo_stat    = (i2c_ch2_fifo_stat_reg*)mt6575_I2C_CH2_FIFO_STAT; 
}
*/
static u32 mt6575_i2c_functionality(struct i2c_adapter *adap)
{
    return I2C_FUNC_I2C | I2C_FUNC_10BIT_ADDR | I2C_FUNC_SMBUS_EMUL;
}

static void mt6575_i2c_post_isr(struct mt6575_i2c *i2c, u16 addr)
{
...
static void i2c_hrtimer_set_expire(struct mt6575_i2c *i2c, u16 time, u16 len)
{
	u32 tmp;
...
static int i2c_hrtimer_start(struct mt6575_i2c_hrtimer_t *i2c_timer, u8 *ptr, u16 data_size)
{
	int ret = 0;
	...
	hrtimer_debug->count = 0;
	hrtimer_debug->i2c = container_of(i2c_timer, struct mt6575_i2c, i2c_hrtimer);;
#endif	
...
static enum hrtimer_restart mt6575_i2c_hrtimer_func(struct hrtimer *timer)
{

	struct mt6575_i2c_hrtimer_t *i2c_timer = container_of(timer, struct mt6575_i2c_hrtimer_t, hrtimer);
	struct mt6575_i2c *i2c = container_of(i2c_timer, struct mt6575_i2c, i2c_hrtimer);
    u32 base;
	u16 fifo_stat;	
	u8 fifo_left;
	...
	u8 i;
	if(i2c == NULL){
		printk("mt6575_i2c_hrtimer:i2c NULL point\n");
		return HRTIMER_NORESTART;
	}
	
	base = i2c->base;
	fifo_stat = I2C_READ_REG(i2c->base, OFFSET_FIFO_STAT);	
	fifo_left = I2C_FIFO_SIZE - (u8)((fifo_stat >> 4) & 0x000F);
	
#ifdef MT6575_I2C_HRTIMER_DEBUG	
	if(hrtimer_debug->count < 256){
		hrtimer_debug->t[hrtimer_debug->count] = sched_clock();
		hrtimer_debug->fifo[hrtimer_debug->count] = fifo_left;
	}
	hrtimer_debug->count++;
#endif	
...
static int mt6575_i2c_start_xfer(struct mt6575_i2c *i2c, struct i2c_msg *msg)
{
    u32 base = i2c->base;
    u16 addr = msg->addr;
    u16 flags = msg->flags;
    ...
    u16 control;  
	u8 i;
	struct mt6575_i2c_hrtimer_t *i2c_timer = &i2c->i2c_hrtimer;

    if( (base != I2C0_BASE) && (base != I2C1_BASE) && (base != I2C2_BASE) )
    {
        dev_err(i2c->dev, "[mt6575_i2c_start_xfer] mt6575-i2c:base(%x) is error.\n", base);
        aee_kernel_exception("i2c dump","i2c->base is wrong in mt6575_i2c_start_xfer!!");
        ret = -EINVAL;
        goto error;
    }
	if(!msg->buf){
        dev_err(i2c->dev, "mt6575-i2c:data buffer is NULL.\n");
		ret = -EINVAL;
		goto error;
    }
	if(!msg->addr){
       	dev_err(i2c->dev, "mt6575-i2c:addr is invalid.\n");
		ret = -EINVAL;
		goto error;
	}
    if (unlikely(msg->addr & I2C_CH2_FLAG))
    {
        ...
        I2C_IRQSET_CH2;
        if(i2c->id != 2)
					dev_err(i2c->dev, "mt6575-i2c:(%x) this port does not support channel2 transfer.\n", msg->addr);
				if (unlikely(msg->addr & I2C_HS_FLAG)) 
          dev_err(i2c->dev, "mt6575-i2c:(%x) channel 2 does not support high speed transfer.\n", msg->addr);
        if(msg->addr & 0x0100)
          dev_err(i2c->dev, "mt6575-i2c:(%x) channel 2 does not support bus hold.\n", msg->addr);
			}
    else
    	{
        i2c->use_ch2 = false;
...
**********************************************************************/       
    if(0 == (msg->timing & 0xffff)){
        speedret = mt6575_i2c_set_speed(i2c, ST_MODE, MAX_ST_MODE_SPEED);
		    	
    }else{
        if (unlikely(msg->addr & I2C_HS_FLAG)) 
            speedret = mt6575_i2c_set_speed(i2c, HS_MODE, msg->timing & 0xffff);
        else
            speedret = mt6575_i2c_set_speed(i2c, FS_MODE, msg->timing & 0xffff);
	
    }
	i2c_hrtimer_set_expire(i2c, msg->timing, msg->len);

    if(-ENOTSUPP == speedret){ 
    	dev_err(i2c->dev, "mt6573-i2c:(%x) speed set %x is invalid.\n", msg->addr,msg->timing);
		ret = -EINVAL;
		goto error;
    }
...
**********************************************************************/       
    ...
    if(I2C_TRANS_STOP == i2c->st_rs) {
    	if (unlikely(true == i2c->use_ch2)) {
			I2C2_CH2_ERR(i2c->dev,msg->addr);
        	if((i2c->delay_len) >> 2)
            dev_err(i2c->dev, "mt6575-i2c:(%x) the delay_len is too long.\n", msg->addr);
        }else{
        	if((i2c->delay_len) >> 8)
            dev_err(i2c->dev, "mt6575-i2c:(%x) the delay_len is too long.\n", msg->addr);
      	}        	
...
**********************************************************************/    
    ...
    if(I2C_MASTER_WRRD != i2c->op && I2C_MASTER_WR != i2c->op && I2C_MASTER_RD != i2c->op){
        dev_err(i2c->dev, "mt6575-i2c:(%x) op is invalid.\n", msg->addr);
		ret = -EINVAL;
		goto error;
	}
...
**********************************************************************/
        ...
        if(I2C_MASTER_WRRD != i2c->op) {
            ...
            if(!trans_len || !trans_num) {
                dev_err(i2c->dev, "mt6575-i2c:(%x) non-WRRD transfer length is not right. trans_len=%x, tans_num=%x, msg len=%x\n", msg->addr, trans_len, trans_num, msg->len);
				ret = -EINVAL;
				goto error;
			}		
        } else {
            ...
            if(!trans_len || !trans_auxlen) {
               	dev_err(i2c->dev, "mt6575-i2c:(%x) WRRD transfer length is not right. trans_len=%x, tans_num=%x, trans_auxlen=%x\n", msg->addr, trans_len, trans_num, trans_auxlen);
				ret = -EINVAL;
				goto error;
			}
        }
...
***************************************************************************/
    ...
    if (unlikely(true == i2c->use_ch2)) {
        ...
        if(msg->addr & 0x0100)
            __raw_writew(0x1, mt6575_I2C_IO_CONFIG);
        else
            __raw_writew(0x0, mt6575_I2C_IO_CONFIG);
    ...
    if (tmo == 0) {
        if (likely(!(addr & I2C_A_FILTER_MSG))) {
            ...
            if (unlikely(true == i2c->use_ch2)) {
                ...
                dev_err(i2c->dev, "I2C register:\nCH2_SLAVE_ADDR %x\nINTR_MASK %x\nINTR_STAT %x\nCH2_CONTROL %x\nCH2_TRANSFER_LEN %x\nCH2_TRANSAC_LEN %x\nCH2_DELAY_LEN %x\nCH2_TIMING %x\nCH2_START %x\nCH2_FIFO_STAT %x\nDEBUGSTAT %x\n",(__raw_readl(mt6575_I2C_CH2_SLAVE_ADDR)),(__raw_readl(mt6575_I2C_INTR_MASK)),(__raw_readl(mt6575_I2C_INTR_STAT)),(__raw_readl(mt6575_I2C_CH2_CONTROL)),(__raw_readl(mt6575_I2C_CH2_TRANSFER_LEN)),(__raw_readl(mt6575_I2C_CH2_TRANSAC_LEN)),(__raw_readl(mt6575_I2C_CH2_DELAY_LEN)),(__raw_readl(mt6575_I2C_CH2_TIMING)),(__raw_readl(mt6575_I2C_CH2_START)),(__raw_readl(mt6575_I2C_CH2_FIFO_STAT)),(__raw_readl(mt6575_I2C_DEBUGSTAT)));
            } else {
                ...
                dev_err(i2c->dev, "I2C register:\nSLAVE_ADDR %x\nINTR_MASK %x\nINTR_STAT %x\nCONTROL %x\nTRANSFER_LEN %x\nTRANSAC_LEN %x\nDELAY_LEN %x\nTIMING %x\nSTART %x\nFIFO_STAT %x\nIO_CONFIG %x\nHS %x\nDEBUGSTAT %x\n",(__raw_readl(mt6575_I2C_SLAVE_ADDR)),(__raw_readl(mt6575_I2C_INTR_MASK)),(__raw_readl(mt6575_I2C_INTR_STAT)),(__raw_readl(mt6575_I2C_CONTROL)),(__raw_readl(mt6575_I2C_TRANSFER_LEN)),(__raw_readl(mt6575_I2C_TRANSAC_LEN)),(__raw_readl(mt6575_I2C_DELAY_LEN)),(__raw_readl(mt6575_I2C_TIMING)),(__raw_readl(mt6575_I2C_START)),(__raw_readl(mt6575_I2C_FIFO_STAT)),(__raw_readl(mt6575_I2C_IO_CONFIG)),(__raw_readl(mt6575_I2C_HS)),(__raw_readl(mt6575_I2C_DEBUGSTAT)));
            }
        ...
        if (i2c->id != 2){
            if ( (base == I2C2_BASE)){
                dev_err(i2c->dev, "[mt6575_i2c_start_xfer] mt6575-i2c:base(%x)=I2C2_BASE but ID !=2.\n", base);
                aee_kernel_exception("i2c dump","(i2c->id != 2) && (base == I2C2_BASE) !!");
                ret = -EINVAL;
                goto error;
            }
            dev_err(i2c->dev, "[mt6575_i2c_start_xfer] SOFTREST mt6575-i2c:base(%x).\n", base);
	...
	//result analyse
        ...
        if (i2c->id != 2){
            ...
            dev_err(i2c->dev, "[mt6575_i2c_start_xfer] SOFTRESET mt6575-i2c:base(%x)\n", base);
            I2C_WRITE_REG(base, OFFSET_SOFTRESET, 0x1);
        }
...
static irqreturn_t mt6575_i2c_irq(int irqno, void *dev_id)
{
    struct mt6575_i2c *i2c;
    u32 base;
    
    i2c = (struct mt6575_i2c*)dev_id;
    base = i2c->base;

    if( (base != I2C0_BASE) && (base != I2C1_BASE) && (base != I2C2_BASE) )
    {
        dev_err(i2c->dev, "[mt6575_i2c_irq] mt6575-i2c:base(%x) is error.\n", base);	
        aee_kernel_exception("i2c dump","i2c->base is wrong in mt6575_i2c_irq!!");
    }
#ifdef MT6575_I2C_HRTIMER_DEBUG    
	 if ( i2c->id == 1 )
...
static int mt6575_i2c_do_transfer(struct mt6575_i2c *i2c, struct i2c_msg *msgs, int num)
{
    int ret = 0;
    int left_num = num;
    
    while (left_num--) {
        ret = mt6575_i2c_start_xfer(i2c, msgs++);
        if (ret < 0)
            return ret;
    }
...
static int mt6575_i2c_transfer(struct i2c_adapter *adap, struct i2c_msg msgs[], int num)
{
    struct mt6575_i2c *i2c = i2c_get_adapdata(adap);
	...
	if(i2c->id == 2){	//PMIC use only.
	    for (retry = 0; retry < 3; retry++) {
	        ret = mt6575_i2c_do_transfer(i2c, msgs, num);
	        if (ret != -EAGAIN) {
	            break;
	        }
...
static void mt6575_i2c_free(struct mt6575_i2c *i2c)
{
    if (!i2c)
        return;
...
static int mt6575_i2c_set_speed(struct mt6575_i2c *i2c, int mode, unsigned long khz)
{
    ...
    if( (base != I2C0_BASE) && (base != I2C1_BASE) && (base != I2C2_BASE) )
	{
        dev_err(i2c->dev, "[mt6575_i2c_set_speed] mt6575-i2c:base(%x) is error.\n", base);
        aee_kernel_exception("i2c dump","i2c->base is wrong in mt6575_i2c_set_speed!!");
    }
    
    if((mode == FS_MODE && khz > MAX_FS_MODE_SPEED) || 
        (mode == HS_MODE && khz > MAX_HS_MODE_SPEED))
        dev_err(i2c->dev, "mt6575-i2c: the speed is too fast for this mode.\n");
    ...
    if (mode == HS_MODE) {
            tmp  = __raw_readw(mt6575_I2C_TIMING) & ~((0x7 << 8) | (0x3f << 0));
            tmp  = (0 & 0x0) << 8 | (20 & 0x3f) << 0 | tmp;
            __raw_writew(tmp, mt6575_I2C_TIMING);
        
        tmp  = __raw_readw(mt6575_I2C_HS) & ~((0x7 << 12) | (0x7 << 8));
        tmp  = (sample_cnt_div & 0x7) << 12 | (step_cnt_div & 0x7) << 8 | tmp;
        __raw_writew(tmp, mt6575_I2C_HS);
        I2C_SET_HS_MODE(1);
    }
    else {
        if (unlikely(true == i2c->use_ch2)) {
            tmp  = __raw_readw(mt6575_I2C_CH2_TIMING) & ~((0x7 << 8) | (0x3f << 0));
            tmp  = (sample_cnt_div & 0x7) << 8 | (step_cnt_div & 0x3f) << 0 | tmp;
            __raw_writew(tmp, mt6575_I2C_CH2_TIMING);
        } else {
            tmp  = __raw_readw(mt6575_I2C_TIMING) & ~((0x7 << 8) | (0x3f << 0));
            tmp  = (sample_cnt_div & 0x7) << 8 | (step_cnt_div & 0x3f) << 0 | tmp;
            __raw_writew(tmp, mt6575_I2C_TIMING);    
...
#ifdef I2C_DEBUG_LOG 
    dev_info(i2c->dev, "mt6575-i2c: set sclk to %ldkhz (orig: %ldkhz), sample=%d, step=%d\n", sclk, khz, sample_cnt_div, step_cnt_div);
#endif
end:
...
static void mt6575_i2c_init_hw(struct mt6575_i2c *i2c)
{
    u32 base = i2c->base;

    if( (base != I2C0_BASE) && (base != I2C1_BASE) && (base != I2C2_BASE) )
    {
        dev_err(i2c->dev, "[mt6575_i2c_init_hw] mt6575-i2c:base(%x) is error.\n", base);
        aee_kernel_exception("i2c dump","i2c->base is wrong in mt6575_i2c_init_hw!!");
    }

    I2C_WRITE_REG(base, OFFSET_SOFTRESET, 0x1);
}

static struct i2c_algorithm mt6575_i2c_algorithm = {    
    .master_xfer   = mt6575_i2c_transfer,
    .smbus_xfer    = NULL,
    .functionality = mt6575_i2c_functionality,
};

static struct i2c_adapter mt6575_i2c_adaptor[] = {
    {
//        .id                     = 0,
        .owner                  = THIS_MODULE,
        .name                   = "mt6575-i2c",
        .algo                   = &mt6575_i2c_algorithm,
        .algo_data              = NULL,
...
static int mt6575_i2c_probe(struct platform_device *pdev)
{
    int ret, irq;
    
    struct mt6575_i2c *i2c = NULL;
    ...
    if (NULL == (i2c = kzalloc(sizeof(struct mt6575_i2c), GFP_KERNEL))) 
        return -ENOMEM;
    
    
    /* initialize mt6575_i2c structure */
    irq = pdev->resource[1].start;
    i2c->id = pdev->id;
    i2c->base = pdev->resource[0].start;
    i2c->irqnr = irq;
    i2c->clk    = mt6575_get_bus_freq() / 16;	
    i2c->adap   = &mt6575_i2c_adaptor[pdev->id];
    i2c->dev    = &mt6575_i2c_adaptor[pdev->id].dev;
...
//	    mt65xx_irq_set_polarity(irq, MT65xx_POLARITY_LOW);
    ...
    ret = request_irq(irq, mt6575_i2c_irq, IRQF_TRIGGER_LOW, DRV_NAME, i2c);
    ...
    mt6575_i2c_init_hw(i2c);
    
	hrtimer_init(&i2c->i2c_hrtimer.hrtimer, CLOCK_MONOTONIC, HRTIMER_MODE_REL);
	i2c->i2c_hrtimer.hrtimer.function = mt6575_i2c_hrtimer_func;	
#ifdef MT6575_I2C_HRTIMER_DEBUG
    ...
    snprintf(i2c->adap->name, sizeof(i2c->adap->name), "mt6575_i2c-i2c.%u",
        i2c->adap->nr);
...
static int mt6575_i2c_remove(struct platform_device *pdev)
{
    struct mt6575_i2c *i2c = platform_get_drvdata(pdev);
...
#ifdef CONFIG_PM
static int mt6575_i2c_suspend(struct platform_device *pdev, pm_message_t state)
{
    struct mt6575_i2c *i2c = platform_get_drvdata(pdev); 
    dev_dbg(i2c->dev,"[I2C %d] Suspend!\n", i2c->id);
    
    #if 0
    struct mt6575_i2c *i2c = dev_get_drvdata(pdev);    
...
static int mt6575_i2c_resume(struct platform_device *pdev)
{
    struct mt6575_i2c *i2c = platform_get_drvdata(pdev); 
...
static struct platform_driver mt6575_i2c_driver = {
    .probe	 = mt6575_i2c_probe,
    .remove	 = mt6575_i2c_remove,
#ifdef CONFIG_PM
    .suspend = mt6575_i2c_suspend,
    .resume	 = mt6575_i2c_resume,
#endif
    .driver  = {
        .name  = DRV_NAME,
        .owner = THIS_MODULE,
...
static int __init mt6575_i2c_init(void)
{
    int ret;

    ret = platform_driver_register(&mt6575_i2c_driver);

    return ret;
}

static void __exit mt6575_i2c_exit(void)
{
    platform_driver_unregister(&mt6575_i2c_driver);
}

module_init(mt6575_i2c_init);
module_exit(mt6575_i2c_exit);
...
int mt6575_i2c_polling_read(int port, unsigned char addr, unsigned char *buffer, int len)
{
  u32   base;
	u8   *ptr  = buffer;
	int   ret  = len;
  ...
  unsigned short status; 
	...
	if(len > I2C_FIFO_SIZE)
		printk(KERN_ERR"mt6575-i2c polling: len is too long.\n");

    /* CHECKME. mt6575 doesn't support len = 0. */
	if (!len)
	{
		printk(KERN_ERR"mt6575-i2c polling: data buffer is NULL.\n");
		return 0;
	}
...
//	I2C_SET_BITS(1<<18, PDN_CLR0);
    ...
    while (1) {
        ...
        if ( status & I2C_TRANSAC_COMP && (!I2C_FIFO_IS_EMPTY) ) {
            ...
            ret = 1;
            printk(KERN_ERR"mt6575-i2c polling: transaction nack error %d\n", ret);  
            break;
        }
        else if ( status & I2C_ACKERR) {
            ret = 2;
            printk(KERN_ERR"mt6575-i2c polling: transaction ack error %d\n", ret);
            ...
            ret = 3;
            printk(KERN_ERR"mt6575-i2c polling: transaction timeout\n");
            printk(KERN_ERR"I2C register:\nSLAVE_ADDR %x\nINTR_MASK %x\nINTR_STAT %x\nCONTROL %x\nTRANSFER_LEN %x\nTRANSAC_LEN %x\nDELAY_LEN %x\nTIMING %x\nSTART %x\nFIFO_STAT %x\nIO_CONFIG %x\nHS %x\nDEBUGSTAT %x\n",(__raw_readl(mt6575_I2C_SLAVE_ADDR)),(__raw_readl(mt6575_I2C_INTR_MASK)),(__raw_readl(mt6575_I2C_INTR_STAT)),(__raw_readl(mt6575_I2C_CONTROL)),(__raw_readl(mt6575_I2C_TRANSFER_LEN)),(__raw_readl(mt6575_I2C_TRANSAC_LEN)),(__raw_readl(mt6575_I2C_DELAY_LEN)),(__raw_readl(mt6575_I2C_TIMING)),(__raw_readl(mt6575_I2C_START)),(__raw_readl(mt6575_I2C_FIFO_STAT)),(__raw_readl(mt6575_I2C_IO_CONFIG)),(__raw_readl(mt6575_I2C_HS)),(__raw_readl(mt6575_I2C_DEBUGSTAT)));
    ...
    if (!ret) {
        while (len--) {
		    I2C_READ_BYTE(*ptr);
//			printk(KERN_ERR"mt6575-i2c polling: read byte = 0x%.2X\n", *ptr);
			ptr++;
		}
    }
...
int mt6575_i2c_polling_write(int port, unsigned char addr, unsigned char *buffer, int len)
{
  u32    base;
	u8    *ptr = buffer;
	int    ret = len;
...
//	I2C_SET_BITS(1<<18, PDN_CLR0);
    ...
    while (len--) {
	    I2C_WRITE_BYTE(*ptr);
//		printk(KERN_ERR"mt6575-i2c polling: write byte = 0x%.2X\n", *ptr);
		ptr++;
    }
...
int mt6575_i2c_polling_writeread(int port, unsigned char addr, unsigned char *buffer, int write_len, int read_len)
{
  u32    base;
	u8    *ptr = buffer;
	int    ret = read_len;
...
EXPORT_SYMBOL(mt6575_i2c_polling_read);
EXPORT_SYMBOL(mt6575_i2c_polling_write);
EXPORT_SYMBOL(mt6575_i2c_polling_writeread);
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("MediaTek mt6575 I2C Bus Driver");
