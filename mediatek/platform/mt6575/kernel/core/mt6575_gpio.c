...
/******************************************************************************
 MACRO Definition
******************************************************************************/
#define GPIO_DEVICE "mt6575-gpio"
...
static struct mt6575_gpio_obj gpio_dat = {
    .ref  = ATOMIC_INIT(0),
    .cls  = NULL,
    .dev  = NULL,
...
static struct mt6575_gpio_obj *gpio_obj = &gpio_dat;
/*---------------------------------------------------------------------------*/
s32 mt_set_gpio_dir(u32 pin, u32 dir)
{
    u32 pos;
    u32 bit;
    struct mt6575_gpio_obj *obj = gpio_obj;
...
{
    int idx;
    struct mt6575_gpio_obj *obj = (struct mt6575_gpio_obj*)dev_get_drvdata(dev);
...
{
    struct mt6575_gpio_obj *obj = platform_get_drvdata(dev);
    int err;
...
MODULE_DESCRIPTION("MT6573 General Purpose Driver (GPIO) $Revision$");
MODULE_LICENSE("GPL");
/*---------------------------------------------------------------------------*/
#endif
