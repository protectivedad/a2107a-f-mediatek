...
static void mt6575_gpt_init(void);
...
static cycle_t mt6575_gpt_read(struct clocksource *cs)
{
	unsigned int cnt1, cnt2, cnt3,value1;
	cnt1 = DRV_Reg32(GPT2_COUNT);
    cnt2 = DRV_Reg32(GPT2_COUNT);
...
static int mt6575_gpt_set_next_event(unsigned long cycles,
...
{
	return mt6575_gpt_set_next_event(cycles, NULL);
}

static void mt6575_gpt_set_mode(enum clock_event_mode mode,
                                struct clock_event_device *evt)
{
    unsigned long ctrl;	
...
struct mt65xx_clock mt6575_gpt =
{
    .clockevent =
    {
        .name           = "mt6575-gpt",
        ...
        .shift          = 32,
        .rating         = 300,
        .set_next_event = mt6575_gpt_set_next_event,
        .set_mode       = mt6575_gpt_set_mode,
    },
    .clocksource =
    {
        .name   = "mt6575-gpt",
        .rating = 300,
        .read   = mt6575_gpt_read,
    ...
    .irq =
    {
        ...
        .handler    = GPT_LISR,
        .dev_id     = &mt6575_gpt.clockevent,
        .irq        = MT6575_APARM_GPTTIMER_IRQ_LINE,
    },
    .init_func = mt6575_gpt_init,
};

static void mt6575_gpt_init(void)
{
    struct clock_event_device *evt = &mt6575_gpt.clockevent;
    struct clocksource *cs = &mt6575_gpt.clocksource;
    GPT_NUM numGPT;
    ...
    mt65xx_irq_set_sens(MT6575_APARM_GPTTIMER_IRQ_LINE, MT65xx_LEVEL_SENSITIVE);
    mt65xx_irq_set_polarity(MT6575_APARM_GPTTIMER_IRQ_LINE, MT65xx_POLARITY_LOW);
...
MODULE_DESCRIPTION("MT6575 GPT Driver v0.3");
MODULE_LICENSE("GPL");
