...
//    mt6575_irq_set_sens(MT6575_GDMA1_IRQ_ID, MT65xx_LEVEL_SENSITIVE);
//    mt6575_irq_set_polarity(MT6575_GDMA1_IRQ_ID, MT65xx_POLARITY_LOW);

    if (request_irq(MT6575_GDMA1_IRQ_ID, gdma1_irq_handler, IRQF_TRIGGER_LOW, "GDMA1",  NULL)) {
        printk(KERN_ERR"GDMA1 IRQ LINE NOT AVAILABLE!!\n");
    }

//    enable_irq(MT6575_GDMA1_IRQ_ID);

//    mt6575_irq_set_sens(MT6575_GDMA2_IRQ_ID, MT65xx_LEVEL_SENSITIVE);
//    mt6575_irq_set_polarity(MT6575_GDMA2_IRQ_ID, MT65xx_POLARITY_LOW);

    if (request_irq(MT6575_GDMA2_IRQ_ID, gdma2_irq_handler, IRQF_TRIGGER_LOW, "GDMA2",  NULL)) {
        printk(KERN_ERR"GDMA2 IRQ LINE NOT AVAILABLE!!\n");
    }

//    enable_irq(MT6575_GDMA2_IRQ_ID);
