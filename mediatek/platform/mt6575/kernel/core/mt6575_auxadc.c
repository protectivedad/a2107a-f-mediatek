 ...
 * Description:
 * ------------
 *   This Module defines functions of mt6575 AUXADC
 *
 * Author:
 * -------
 * James Lo
...
#include <mach/mt6575_auxadc_sw.h>
...
///////////////////////////////////////////////////////////////////////////////////////////
//// Internal API
inline static void mt6575_ADC_2G_power_up(void)
{
    //2010/07/27: mt6575, the ADC 2G power on is controlled by APMCU_CG_CLR0
    #define PDN_CLR0 (0xF7026308)  
    unsigned int poweron = 1 << 4;
    AUXADC_SET_BITS(poweron, PDN_CLR0);
}

inline static void mt6575_ADC_2G_power_down(void)
{
    //2010/07/27: mt6575, the ADC 2G power on is controlled by APMCU_CG_SET0
    #define PDN_SET0 (0xF7026304)  
    unsigned int poweroff = 1 << 4;
    AUXADC_SET_BITS(poweroff, PDN_SET0);
}

inline static void mt6575_ADC_3G_power_up(void)
{
    //2010/07/27: mt6575, the ADC 3G power on is controlled by APMCU_CG_CLR0
    #define PDN_CLR0 (0xF7026308)  
    unsigned int poweron = 1 << 13;
    AUXADC_SET_BITS(poweron, PDN_CLR0);
}

inline static void mt6575_ADC_3G_power_down(void)
{
    //2010/07/27: mt6575, the ADC 3G power on is controlled by APMCU_CG_SET0
    #define PDN_SET0 (0xF7026304)  
...
int IMM_GetOneChannelValue(int dwChannel, int deCount)
{
    ...
    mt6575_ADC_2G_power_up();
    mt6575_ADC_3G_power_up();
    ...
    mt6575_ADC_2G_power_down();
    mt6575_ADC_3G_power_down();
    ...
    if (auxadc_debug) {
        printk("mt6575_auxadc: auxadc_cali_slop[%d] = %d, auxadc_cali_offset[%d] = %d\n", dwChannel, *(auxadc_cali_slop + dwChannel), dwChannel, *(auxadc_cali_offset + dwChannel));
        printk("mt6575_auxadc: adc_temp_result = %d, adc_result = %d\n", adc_temp_result, adc_result);  
    }
...
// platform_driver API 
static int mt6575_auxadc_probe(struct platform_device *dev)	
{    
    int ret = 0;
    struct class_device *class_dev = NULL;
    
    printk("******** MT6575 AUXADC driver probe!! ********\n");
    ...
    printk("[MT6575 AUXADC_probe] NVRAM prepare : done !!\n");
...
static int mt6575_auxadc_remove(struct platform_device *dev)	
{
    printk("******** MT6575 auxadc driver remove!! ********\n" );    
    return 0;
}

static void mt6575_auxadc_shutdown(struct platform_device *dev)	
{
    printk("******** MT6575 auxadc driver shutdown!! ********\n" );
}

static int mt6575_auxadc_suspend(struct platform_device *dev, pm_message_t state)	
{
    printk("******** MT6575 auxadc driver suspend!! ********\n" );
...
static int mt6575_auxadc_resume(struct platform_device *dev)
{
    printk("******** MT6575 auxadc driver resume!! ********\n" );
	if(enable_clock(MT65XX_PDN_PERI_AUXADC,"AUXADC"))
	{
...
*/
static struct platform_driver mt6575_auxadc_driver = {
    .probe      = mt6575_auxadc_probe,
    .remove     = mt6575_auxadc_remove,
    .shutdown   = mt6575_auxadc_shutdown,
    #ifdef CONFIG_PM
        .suspend = mt6575_auxadc_suspend,
        .resume	 = mt6575_auxadc_resume,
    #endif
    .driver     = {
    .name       = "mt6575-auxadc",
    },
...
static int __init mt6575_auxadc_init(void)
{
    int ret;
    /*
    ...
    */
    ret = platform_driver_register(&mt6575_auxadc_driver);
    if (ret) {
        printk("****[mt6575_auxadc_driver] Unable to register driver (%d)\n", ret);
        return ret;
    }
    
    printk("****[mt6575_auxadc_driver] Initialization : DONE \n");
    return 0;
}

static void __exit mt6575_auxadc_exit (void)
{
}

module_init(mt6575_auxadc_init);
module_exit(mt6575_auxadc_exit);

MODULE_AUTHOR("MTK");
MODULE_DESCRIPTION("MT6575 AUXADC Device Driver");
MODULE_LICENSE("GPL");
