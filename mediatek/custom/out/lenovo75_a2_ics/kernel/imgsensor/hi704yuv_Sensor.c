...
// mtk00719: adjust for customer camera module	
...
void HI704GetAFMaxNumMeteringAreas(UINT32 *pFeatureReturnPara32)
{
	*pFeatureReturnPara32 = 0;
	SENSORDB(" HI704GetAFMaxNumMeteringAreas, *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);
}
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
			HI704GetAFMaxNumMeteringAreas(pFeatureReturnPara32);
			*pFeatureParaLen=4;
			break;
		default:
			 break;			
