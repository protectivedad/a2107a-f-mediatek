...
#define ALS_OUTPUT_AUXADC_PIN  AUXADAC_0     // 4 for experiment
...
int bh1620fvc_als_get_data_from_adc(void)
{
 ...
 // Max Auxadc range = 2.5V, we assume 0~2.3V is linear
...
//=======================================================
    ...
    {
    	if ( enable_clock(MT65XX_PDN_PERI_AUXADC,"AUXADC") == FALSE )
        {
...
{
	APS_FUN();
	i2c_register_board_info(0, &i2c_bh1620fvc, 1);
