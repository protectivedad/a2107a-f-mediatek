...
static struct i2c_board_info __initdata i2c_mmc328xma={ I2C_BOARD_INFO("mmc328x", (0x60>>1))};
...
static int mmc328x_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(err = mmc328x_create_attr(&mmc_sensor_driver.driver))
	{
...
static int mmc328x_i2c_remove(struct i2c_client *client)
{
	...
	if(err = mmc328x_delete_attr(&mmc_sensor_driver.driver))
	{
...
{
	i2c_register_board_info(0, &i2c_mmc328xma, 1);
