...
static int bma222_i2c_detect(struct i2c_client *client, int kind, struct i2c_board_info *info);
...
static int BMA222_WriteCalibration(struct i2c_client *client, int dat[BMA222_AXES_NUM])
{
	...
	int lsb = bma222_offset_resolution.sensitivity;
...
{
	GSE_FUN();
	i2c_register_board_info(0, &i2c_BMA222, 1);
