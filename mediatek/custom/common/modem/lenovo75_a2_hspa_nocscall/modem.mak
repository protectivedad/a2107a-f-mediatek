# Generated at Wed Jan 18 15:57:40 2012
...
BOARD_VER         =  LENOVO75_A2_MODEM_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
RF_MODULE         =  LENOVO75_A2_MODEM_MT6162      # SKY74045, AERO, FOUNTAIN2, SPRING,
                                 # MT6129D, AERO1PLUS
...
UMTS_BAND_VIII = TRUE  # TRUE, FALSE
...
FLAVOR = DISABLE_CSCALL    # FLAVOR = NONE/$(FLAVOR)
...
UMTS_RF_MODULE    =  LENOVO75_A2_MODEM_MT6162
...
PLMN_LIST_PREF_SUPPORT = DEFAULT     # ON, OFF, DEFAULT
...
FAST_DORMANCY_SUPPORT = TRUE     # TRUE: GEMINI_VERSION = V2
...
SIM_RECOVERY_ENHANCEMENT = TRUE      # TRUE: Enable this feature
...
# *************************************************************************
COM_DEFS_FOR_LENOVO75_A2_MODEM_MT6162 = MT6162_RF LENOVO75_A2_MODEM_MT6162
...
CUSTOM_OPTION += __SP_GEMINI_3G_SWITCH__

CUSTOM_OPTION += __DISABLE_CSCALL__

CUSTOM_OPTION += __WCDMA_PREFERRED__ __UMTS_FDD_PREFER__
