# Generated at Fri Oct 21 16:03:23 2011
...
BOARD_VER         =  LENOVO75_MODEM_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
RF_MODULE         =  LENOVO75_DEMO_MT6162      # SKY74045, AERO, FOUNTAIN2, SPRING,
                                 # MT6129D, AERO1PLUS
...
# ------------------------------ LCD
LCD_MODULE        =  LENOVO75_MODEM_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
# ------------------------------ Modem
GPRS_MAX_PDP_SUPPORT = 6     # 1, 2, 3, 4, 5, 6 or 7  Maximum simultaneous PDP contexts (1~7)
...
DUALMACDSP_BIN = MT6575_GPRS_REL_ROM

DUALMACDSP_BL_BIN = MT6575_REL_BL
...
IPV6_PDP_SUPPORT = TRUE      # FALSE, not support IPv6 PDP Context
...
DSPIRDBG_SP          = FALSE      # IRDBG(FCore usb logging) for smart phone
                                  # only support in 6573 & 6575
...
# *************************************************************************
COM_DEFS_FOR_LENOVO75_DEMO_MT6162 = MT6162_RF
COM_DEFS_FOR_MT6162_CUSTOM = MT6162_RF
COM_DEFS_FOR_LENOVO75_MODEM_LCM = LENOVO75_MODEM_LCM
...
CUSTOM_OPTION += __BT_SIM_PROFILE__ __CTA_DUAL_SIM_STANDARD__ __L4C_ROOT__ __SATCE__ __GEMINI_PREEMPT_PEER_SERVICE__
