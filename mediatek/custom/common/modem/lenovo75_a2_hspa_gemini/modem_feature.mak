...
MODEM_BOARD_VER         =  LENOVO75_A2_MODEM_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
MODEM_RF_MODULE         =  LENOVO75_A2_MODEM_MT6162      # SKY74045, AERO, FOUNTAIN2, SPRING,
MODEM_PHONE_TYPE 		=  BAR      # BAR, CLAMSHELL, SLIDE
MODEM_VENDOR = NONE     # NONE: non-vendor project
MODEM_LCD_MODULE        =  TRULY_HVGA_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
MODEM_DEMO_PROJECT		= TRUE   # TRUE, FALSE. TRUE for internal demo project.
MODEM_FLAVOR = ANDROID_GEMINI    # FLAVOR = NONE/$(FLAVOR)
...
MODEM_PRODUCTION_RELEASE	= FALSE	  # Production release feature includs autoreset when system hang
...
MODEM_UMTS_RF_MODULE    =  LENOVO75_A2_MODEM_MT6162
...
MODEM_PLMN_LIST_PREF_SUPPORT = DEFAULT     # ON, OFF, DEFAULT
...
MODEM_FS_TRACE_SUPPORT	=  TRUE  # File system trace feature.
...
MODEM_SIM_RECOVERY_ENHANCEMENT = TRUE      # TRUE: Enable this feature
...
MODEM_WCDMA_PREFERRED = TRUE      # TRUE
...
MODEM_RELEASE_PACKAGE		= REL_SUB_L4_$(strip $(PROJECT))	# REL_CR_MMI_GPRS, REL_CR_MMI_GSM, REL_CR_L4_GPRS, REL_CR_L4_GSM
MODEM_RELEASE_INPUT_METHODS_SRC =		# MMI_ZI, MMI_T9, MMI_ITAP,
MODEM_RELEASE_TYPE = NONE           # NONE, INTERNAL
MODEM_COM_DEFS_FOR_LENOVO75_A2_MODEM_MT6162 = MT6162_RF LENOVO75_A2_MODEM_MT6162
