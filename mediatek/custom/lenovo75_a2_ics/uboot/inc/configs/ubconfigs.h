...
#define MT65XX_FACTORY_KEY	11	/* use Volume Down's hardware keycode for keypad matrix; use MT65XX_PMIC_RST_KEY for PMIC */
#define MT65XX_PMIC_RST_KEY	2	/* use MT65XX_FACTORY_KEY for compat reason, use an unused hardware keycode (0-71) for other cases */
