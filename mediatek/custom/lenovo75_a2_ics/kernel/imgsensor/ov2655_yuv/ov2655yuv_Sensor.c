...
{    
	...
	RETAILMSG(1, (TEXT("MT9P012 write gain: %d\r\n"), gain));
...
void OV2655_night_mode(kal_bool enable)
{
	...
	//	kal_uint8 temp_AE_reg = OV2655_read_cmos_sensor(0x3013);
		 ...
		 SENSORDB("OV2655_night_mode enable=%d, OV2655_sensor_cap_state=%d, OV2655_VEDIO_encode_mode=%d",enable,OV2655_sensor_cap_state,OV2655_VEDIO_encode_mode);
...
UINT32 OV2655Open(void)
{
    ...
    OV2655_write_cmos_sensor(0x3327,0x0c);   //0x0c
    OV2655_write_cmos_sensor(0x3328,0x10);   //Jerry 0x0f
    OV2655_write_cmos_sensor(0x3329,0x13);   //Jerry 0x14
    OV2655_write_cmos_sensor(0x332a,0x58);   //Jerry 0x66
    OV2655_write_cmos_sensor(0x332b,0x56);   //5f -> 5c  //Jerry 0x5c
    OV2655_write_cmos_sensor(0x332c,0xa5);   //a5 -> 89    //Jerry 0x89
    OV2655_write_cmos_sensor(0x332d,0x9b);   //ac -> 96    //Jerry 0x96
    OV2655_write_cmos_sensor(0x332e,0x3a);   //35 -> 3d    //Jerry 0x3d
    OV2655_write_cmos_sensor(0x332f,0x36);   //Jerry 0x2f
    OV2655_write_cmos_sensor(0x3330,0x4d);   //Jerry 0x57
    OV2655_write_cmos_sensor(0x3331,0x44);   //Jerry 0x3d
    OV2655_write_cmos_sensor(0x3332,0xf0);   
    OV2655_write_cmos_sensor(0x3333,0x10);  //0x10 
    ...
    //Color Matrix
    OV2655_write_cmos_sensor(0x3380,0x26); 
    OV2655_write_cmos_sensor(0x3381,0x5a); 
    OV2655_write_cmos_sensor(0x3382,0x08); 
    OV2655_write_cmos_sensor(0x3383,0x2d);  //0x2a
    OV2655_write_cmos_sensor(0x3384,0xb8);  //0xad
    OV2655_write_cmos_sensor(0x3385,0xe4); //d5
    OV2655_write_cmos_sensor(0x3386,0xaf);  
    OV2655_write_cmos_sensor(0x3387,0xab); 
    OV2655_write_cmos_sensor(0x3388,0x04); 
    OV2655_write_cmos_sensor(0x3389,0x98); 
    OV2655_write_cmos_sensor(0x338a,0x01); 

    //Gamma
    OV2655_write_cmos_sensor(0x3340,0x04);  
    OV2655_write_cmos_sensor(0x3341,0x07);  
    OV2655_write_cmos_sensor(0x3342,0x19); 
    OV2655_write_cmos_sensor(0x3343,0x34); 
    OV2655_write_cmos_sensor(0x3344,0x4a); 
    OV2655_write_cmos_sensor(0x3345,0x5a);  //0x60 
    OV2655_write_cmos_sensor(0x3346,0x67);  //0x6a
    OV2655_write_cmos_sensor(0x3347,0x71);  
    OV2655_write_cmos_sensor(0x3348,0x7c);  //0x84
    OV2655_write_cmos_sensor(0x3349,0x8c);  //0x96
    OV2655_write_cmos_sensor(0x334a,0x9b);  //0xa2
    OV2655_write_cmos_sensor(0x334b,0xa9);  //0xac
    OV2655_write_cmos_sensor(0x334c,0xc0);
    OV2655_write_cmos_sensor(0x334d,0xd5);
    OV2655_write_cmos_sensor(0x334e,0xe8);
    OV2655_write_cmos_sensor(0x334f,0x20);    

    //Lens correction
    //R
    OV2655_write_cmos_sensor(0x3350,0x35); 
    OV2655_write_cmos_sensor(0x3351,0x25);
    OV2655_write_cmos_sensor(0x3352,0x00);
    ...
    //B
    OV2655_write_cmos_sensor(0x335c,0x36);
    OV2655_write_cmos_sensor(0x335d,0x25);
    OV2655_write_cmos_sensor(0x335e,0x00);
    OV2655_write_cmos_sensor(0x335f,0x1c);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    OV2655_write_cmos_sensor(0x3016, 0x82);//52->82   
    ...
    OV2655_write_cmos_sensor(0x30a1, 0x01);  //Jerry 0x01
    OV2655_write_cmos_sensor(0x30a3, 0x00);  //0x0
    OV2655_write_cmos_sensor(0x30d9, 0x8c);  //0x8c
    OV2655_write_cmos_sensor(0x3302, 0x11); 
    OV2655_write_cmos_sensor(0x3317, 0x25); 
    OV2655_write_cmos_sensor(0x3318, 0x80); 
    ...
    OV2655_write_cmos_sensor(0x3373, 0x30);//0x40->0x30
    OV2655_write_cmos_sensor(0x3376, 0x06); ///0624,jerry, for preview sharp 04->06
	...
	//mirror and flip  0x3090=0x3b 0x307c=13 ldx 
    OV2655_write_cmos_sensor(0x3090,0x3b);        
    OV2655_write_cmos_sensor(0x307c, 0x13); 
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    OV2655_exposure_line_h = OV2655_read_cmos_sensor(0x3002);
    OV2655_exposure_line_l = OV2655_read_cmos_sensor(0x3003);
    OV2655_extra_exposure_line_h = OV2655_read_cmos_sensor(0x302D);
    OV2655_extra_exposure_line_l = OV2655_read_cmos_sensor(0x302E);
    ...
    {    
        ...
        OV2655_write_cmos_sensor(0x3373,0x30); //0x50->0x30  
        OV2655_write_cmos_sensor(0x3376,0x06); //0x03->0x6
       ...
       // Sleep(95);
        OV2655_write_OV2655_gain(OV2655_Capture_Gain16); 
    }
...
static kal_bool OV2655_sensor_burstcap_flag = KAL_FALSE; //Preview or Capture
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_CAPTURE_MPEG4:
			...
			OV2655_sensor_burstcap_flag = KAL_FALSE;
		break;
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_MEM:
			if(!OV2655_sensor_burstcap_flag)
			{
				OV2655Capture(pImageWindow, pSensorConfigData);
				OV2655_sensor_burstcap_flag = KAL_TRUE;
			}
		break;
		default:
		    break; 
